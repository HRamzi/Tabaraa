...
<body id="page-liste">
    <header class="tabaraa-header">
        ...
        <div class="toolsbar f-container f-align-stretch">
            <div class="limiter-large">
                ...
                <di<div class="f-container f-content-center spaced" id="global-search">
                    <div class="f-item">
    ...
    <div class="deco-bg">
        <div class="container main-bg">
            <div><br><br></div>
            <h2 class="text-left f-item"><b>Annonces Autres</b></h2>
            <div class="container f-container f-wrap-nowrap ">
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <div id="search-wrapper">
                    <div id="search">
                        <!-- Utiliser des liens dynamiques pour afficher les annonces de la catégorie "Autres" -->
                        @if($annonces->count() > 0)
                                ...
                                <div class="f-item f-container f-wrap-nowrap pa-md">
                                    <div class="f-grow-1">
                                        ...
                                        <div class="f-container f-content-end pa-xs">
                                            <button type="button" class="btn blue" onclick="window.location='{{ route('afficherFormulaireConnexion') }}'">Je suis intéressé</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @endif
                        <!-- Ajoutez plus d'annonces "Autres" ici -->
                    </div>
                </div>
            </div>
        </div>
