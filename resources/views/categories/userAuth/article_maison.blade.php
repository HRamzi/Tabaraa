...
<body id="page-liste">
    ...
    <div class="ham-nav ham-right" id="nav-user" data-icon="user" data-title="profil">
        ...
        <div class="ham-content">
            ...
            <a href="{{ route('mesAnnonce') }}" title="Voir la liste de mes annonces">Mes annonces</a>
    ...
    <div class="deco-bg">
        <div class="container main-bg">
            <div><br><br></div>
            <h2 class="text-left f-item"><b>Annonces Articles Maison</b></h2>
            <div class="container f-container f-wrap-nowrap">
                ...
                <div id="search-wrapper">
                    <div id="search">
                                ...
                                <div class="f-item f-container f-wrap-nowrap pa-md">
                                    <div class="f-grow-1">
                                        ...
                                        <div class="f-container f-content-end pa-xs">
                                            <button type="button" onclick="window.location='{{ route('annonce.details', ['id' => $annonce->id]) }}'">je recuper!</button>
                                        </div>
                        ...
                        @endforeach
                        @else <p style="font-weight:bold">Aucune annonce disponible pour cette catégorie.</p>
                        @endif
                    </div>
                </div>
            </div>
