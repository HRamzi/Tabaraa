...
<body id="page-signup">
                    ...
                    <div class="f-container">
                        <div class="f-align-self-start">
                            <a class="f-container logo-picto" href="#" title="Site de don d'objets">
                                <img class="logo f-align-self-center" height="20" width="20" src="{{ asset('assets\images\Tabaraalogo.png') }}" loading="lazy" decoding="async" alt="Tabaraa" />
                            </a>
                    ...
                    <div class="f-grow-1 f-container f-wrap-nowrap f-align-center f-content-end">
                        ...
                        <button title="Accès à mon compte" class="repliable ham-toggle" data-target="nav-user">
                            <span class="shell">
                                ...
                                <img src="{{ asset('storage/' . $utilisateur->photo_profile) }}" alt="Mon avatar" loading="lazy" decoding="async">
                            </span>
                        </button>
    ...
    <div class="ham-nav ham-right" id="nav-user" data-icon="user" data-title="Tabaraa">
        ...
        <div class="ham-content">
            ...
            <a href="mesAnnonce.html" title="mes annonces">Mes annonces</a>
