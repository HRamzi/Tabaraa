...
<body id="page-liste">
            ...
            <div class="limiter-large">
                <div class="f-container f-wrap-nowrap f-item" id="main-appbar">
                    ...
                    <div class="f-container">
                        <div class="f-align-self-start">
                            ...
                            <a class="f-container logo-full" href="#" title="Site de don d'objets">
                                <img class="logo f-align-self-center" height="50" width="100" src="{{ asset('assets\images\Tabaraalogo.png') }}" loading="lazy" decoding="async" alt="Tabaraa" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="f-grow-1 f-container f-wrap-nowrap f-align-center f-content-end">
                        ...
                        <a class="repliable btn  post-holder" href="{{ route('connexion') }}" title="Publier une annonce pour donner un objet">
    ...
    <!-- Votre barre de navigation mobile ici -->
    ...
    <div class="deco-bg">
        <div class="container main-bg">
            <div><br><br></div>
            <h2 class="text-left f-item"><b>Résultats de la Recherche</b></h2>
                            ...
                            <div class="f-grow-1">
                                <div class="f-item f-container f-wrap-nowrap pa-sm">
                                    <div>
                                        ...
                                        <!-- Vous pouvez ajouter d'autres informations de l'annonce ici -->
                                    </div>
                                </div>
